...
We tested the results of section \ref{sec:toy} using a simple monte carlo.  We
used \galsim\ to generate image of Gaussian galaxies convolved by Gaussian
PSFs, and we used the \ngmix\ package
\footnote{\url{https://github.com/esheldon/ngmix}} to fit the template flux.

We varied the PSF size by 
