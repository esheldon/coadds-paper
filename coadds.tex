...
naive estimator.  The filled circles show
\begin{align}
    \sqrt{ \frac{ {\rm var}\hat{A}} { {\rm var}\hat{A}_{\rm multi} } },
\end{align}
or the increase in uncertainty relative to the optimal, multi-epoch
estimator.  In all cases these two ratios are quite similar.  Overplotted
