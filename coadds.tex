...
\author[Armstrong et~al.]{Robert Armstrong$^1$,$^4$\thanks{\tt armstrong46@llnl.gov}, Erin Sheldon$^2$, Eric
...
two independent shear codes: \Mcal and BFD.  The one 
caveat here, is the assumption that we have a principled
coadd, i.e., the PSF is mathematically well-defined.
...
from the HSC Ultra-Deep~\citep{HSC_DR1} data.  The HSC Ultra-Deep data is 
...
differnt patch sizes (0.1, 0.5 and 0.8 arcminutes) and the two dither patterns 
